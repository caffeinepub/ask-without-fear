...
export class Backend implements backendInterface {
    ...
    async deleteDoubt(arg0: string): Promise<void> {
    ...
    async getDoubtsByCategory(arg0: string): Promise<Array<Doubt>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDoubtsByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitDoubt(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.submitDoubt(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateDoubt(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateDoubt(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
